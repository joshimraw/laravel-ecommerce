  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('frontend/css/plugins/OwlCarousel2-2.2.1/owl.theme.default.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('frontend/css/plugins/OwlCarousel2-2.2.1/animate.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('frontend/css/plugins/slick-1.8.0/slick.css')}}">
